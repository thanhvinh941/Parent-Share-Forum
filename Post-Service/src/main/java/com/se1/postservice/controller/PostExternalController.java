...
//	}
	...
	public ResponseEntity<?> findAllPost(@RequestHeader("user_detail") String userDetail) throws JsonMappingException, JsonProcessingException{
		UserDetail detail = objectMapper.readValue(userDetail, UserDetail.class);
		
		try {
			postService.findAllPost(detail, apiResponseEntity);
		} catch (Exception e) {
