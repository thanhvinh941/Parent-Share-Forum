...
import com.se1.systemservice.domain.rabbitMQ.dto.NotifyDto;
...
public class SystemListenerService {
	...
	public void processActionSystemContact(ContactDto data) throws JsonProcessingException {
		...
		case 1: // Request Friend
			NotifyDto notifyRequestFriend = generatorNotifyDto(userSender, userReciver, data.getTopicId(), status);
		...
		case 2: // Accept Friend
			NotifyDto notifyUnfiendOrAcceptFriend = generatorNotifyDto(userReciver, userSender,data.getTopicId(), status);
	...
	private NotifyDto generatorNotifyDto(UserDetail userFrom, UserDetail userTo, String TopicId, int status) throws JsonProcessingException {
