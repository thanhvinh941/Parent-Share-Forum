...
public class CommonUtil {
	...
	public static final SimpleDateFormat dateFormatYYYYMMDDHHMMSS = new SimpleDateFormat(
			SCMConstant.DATE_YYYYMMDD_HHMMSS);
	...
	public static Class<?> checkTypeByKey(String key, Class<?> classTarget) {
		...
		Map<String, Class<?>> specificFieldMap = specificFieldList.stream()
